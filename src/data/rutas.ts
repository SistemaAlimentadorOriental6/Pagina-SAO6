...
export const RUTAS: Ruta[] = [
    ...
    {
        codigo: 'C6-002',
        nombre: 'Versalles - Punto Cero - Hospital',
    ...
    {
        codigo: 'C6-004A',
        nombre: 'Quinta Linda - Exposiciones',
        slug: 'quinta-linda-exposiciones',
        color: '#2c5f5d',
    ...
    {
        codigo: 'C6-005',
        nombre: 'Vergel - Parque San Antonio',
        slug: 'vergel-parque-san-antonio',
        color: '#4cc253',
        descripcion: 'Ruta C6-005 desde El Vergel hasta el Parque San Antonio. Conexión vital entre los barrios altos de la comuna 8 y el centro de Medellín.',
        videoUrl: 'https://www.youtube.com/embed/E--HGyf5I54',
    ...
    {
        codigo: 'C6-006',
        nombre: 'Villa Liliam - Catedral Metropolitana',
    ...
    {
        codigo: 'C6-007',
        nombre: 'Cataluña - San Antonio',
        slug: 'cataluna-san-antonio',
        color: '#4cc253',
        descripcion: 'Ruta C6-007 conectando el barrio Cataluña y Buenos Aires con la Estación San Antonio. Enlace directo con las líneas A y B del Metro y el Tranvía.',
        videoUrl: 'https://www.youtube.com/embed/lJVzruUeVaQ',
        mapaUrl: 'https://www.google.com/maps/d/embed?mid=1Nr5ScPQMx4CIYR5w-sLnlzkUcKzsWx8&ehbc=2E312F',
        keywords: ['Cataluña', 'Buenos Aires', 'Estación San Antonio', 'Tranvía Ayacucho', 'C6-007', 'Metro']
    },
    {
        codigo: 'C6-008',
    ...
    },
    {
        ...
        videoUrl: 'https://www.youtube.com/embed/q-fykY3aLHc',
    ...
    {
        codigo: 'C6-010',
        nombre: 'Villatina - ITM - Prado',
        slug: 'villatina-itm-prado',
        color: '#2c5f5d',
        ...
        videoUrl: 'https://www.youtube.com/embed/NuRlCbGzt-Q',
    ...
    {
        codigo: 'C6-011',
        nombre: 'El Playón - Popular 2 - Acevedo',
        slug: 'el-playon-popular-2-acevedo',
        color: '#4cc253',
    ...
    {
        codigo: 'C6-012',
        nombre: 'La Francia - Aranjuez - Acevedo',
        slug: 'la-francia-aranjuez-acevedo',
        color: '#2c5f5d',
    ...
    {
        codigo: 'C6-012A',
        nombre: 'Andalucía - Acevedo',
        slug: 'andalucia-acevedo',
        color: '#4cc253',
    ...
    {
        codigo: 'C6-013',
        nombre: 'Popular 1 - Tricentenario',
        slug: 'popular-1-tricentenario',
        color: '#2c5f5d',
    ...
    {
        codigo: 'C6-014',
        nombre: 'La Ladera - Prado',
        slug: 'la-ladera-prado',
        color: '#4cc253',
        ...
        videoUrl: 'https://www.youtube.com/embed/8_NDbXaIVxc',
    ...
    {
        codigo: 'C6-015',
        nombre: 'Villa de Guadalupe - Hospital',
        slug: 'villa-de-guadalupe-hospital',
        color: '#2c5f5d',
    ...
    {
        codigo: 'C6-018',
        nombre: 'Santa Cecilia - Tricentenario',
        slug: 'santa-cecilia-tricentenario',
        color: '#2c5f5d',
    ...
    {
        codigo: 'C6-019',
        nombre: 'Gardel - Raizal',
        slug: 'gardel-raizal',
        color: '#4cc253',
        descripcion: 'Ruta C6-019 interbarrial conectando Gardel y Raizal. Facilita la movilidad interna en la zona de Manrique y Aranjuez.',
        ...
        keywords: ['Gardel', 'Raizal', 'Manrique', 'Aranjuez', 'C6-019', 'Ruta Interna']
    },
    {
        codigo: 'C6-019A',
        nombre: 'El Jardín - Gardel',
        slug: 'el-jardin-gardel',
        color: '#2c5f5d',
        descripcion: 'Ruta C6-019A conectando el sector de El Jardín con Gardel. Servicio complementario para la movilidad en la comuna 3 y 4.',
        ...
        keywords: ['El Jardín', 'Gardel', 'Manrique', 'C6-019A', 'Transporte Local']
    },
    {
        codigo: 'C6-020',
    ...
    {
        codigo: 'C6-021',
        nombre: 'Granizal - Aranjuez',
        slug: 'granizal-aranjuez',
        color: '#2c5f5d',
        descripcion: 'Ruta C6-021 conectando el barrio Granizal con el centro de Aranjuez. Facilita el acceso a servicios comerciales y transporte en la zona.',
        ...
        keywords: ['Granizal', 'Aranjuez', 'Comuna 1', 'Santo Domingo', 'C6-021', 'Transporte']
    },
    {
        codigo: 'C6-022',
    ...
    {
        codigo: 'C6-022A',
        nombre: 'Estación Prado - Las Partidas',
        slug: 'estacion-prado-las-partidas',
        color: '#2c5f5d',
        descripcion: 'Ruta C6-022A conectando Estación Prado con el sector de Las Partidas. Servicio de refuerzo para la movilidad hacia las zonas altas.',
        ...
        keywords: ['Estación Prado', 'Las Partidas', 'Santa Elena', 'C6-022A', 'Transporte']
    },
    {
        codigo: 'C6-023',
        nombre: 'Santa Lucía - Alejandro Echavarría',
        slug: 'santa-lucia-alejandro-echavarria',
        color: '#4cc253',
        descripcion: 'Ruta C6-023 conectando Santa Lucía con Alejandro Echavarría. Enlace importante entre estaciones del Tranvía y barrios de la comuna 9.',
    ...
    {
        codigo: 'C6-024',
        nombre: '8 de Marzo - Alejandro Echavarría',
        slug: '8-de-marzo-alejandro-echavarria',
        color: '#2c5f5d',
        descripcion: 'Ruta C6-024 desde el barrio 8 de Marzo hasta Alejandro Echavarría. Conexión para los residentes de la zona centro-oriental con el sistema integrado.',
    ...
    {
        codigo: 'C6-025',
        nombre: '8 de Marzo - Estación Oriente',
        slug: '8-de-marzo-estacion-oriente',
        color: '#4cc253',
        descripcion: 'Ruta C6-025 conectando 8 de Marzo directamente con la Estación Oriente del Tranvía. Acceso rápido al sistema de transporte masivo.',
    ...
    {
        codigo: 'C6-025B',
        nombre: 'Bosque Verde - Oriente',
        slug: 'bosque-verde-oriente',
        color: '#2c5f5d',
